...
import data from '../constant/realstate.json'

const RealState = () => {
  return (
    <div>
        <div className='flex justify-between w-[72%]'>
      <h1 className="font-larsseit mb-2 ms-[8%] text-[18px]">Popular in Real Estate in Canada</h1>
      <p className='right-0 ms-10'>Browse All Real Estate</p>
      </div>
