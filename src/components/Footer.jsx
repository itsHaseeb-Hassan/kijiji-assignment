...
const Footer = () => {
  return (
    <footer className="bg-footerBg text-gray-400 py-10 ">
      <div className=" container grid gap-5 grid-cols-2 md:grid-cols-4  mx-auto w-[75%]">
        <div>
          ...
          <ul className="text-[16px]  text-primary font-larsseit">
            <li className="mb-5 hover:text-secondary">
              <a href="#">About</a>
            </li>
            <li className="mb-5 hover:text-secondary">
              <a href="#">Join Us</a>
        ...
        <div>
          ...
          <ul className="text-[16px]  text-primary font-larsseit">
            <li className="mb-5 hover:text-secondary">
              <a href="#">Kijiji Autos</a>
            </li>
            <li className="mb-5 hover:text-secondary">
              <a href="#">Kijiji Central</a>
            </li>
            <li className="mb-5 hover:text-secondary">
      ...
      <div className="flex flex-col max-w-[600px] mx-auto gap-8 md:flex-row ">
        <div className="flex mx-auto md:mx-0">
          ...
          <img
            ...
            className="mx-5 w-[140px] h-[140px] object-cover"
          />
        </div>
