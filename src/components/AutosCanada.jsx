...
const AutosCanada = () => {
  return (
    ...
    <div className=' w-[90%]  md:w-[70%] ms-[5%] mx-auto'>
      <div className='flex justify-between'>
        <h1 className="font-larsseit mb-2 text-[18px]">Popular in Buy and Sell in Canada</h1>
        <p className='md:me-10'>Browse All Autos</p>
      </div>
      <div className="container w-full ms-0 mb-28">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 items-center h-full mx-auto">
